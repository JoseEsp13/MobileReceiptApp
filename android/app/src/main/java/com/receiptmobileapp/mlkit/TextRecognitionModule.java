package com.receiptmobileapp.mlkit;
                ...
                .addOnSuccessListener(new OnSuccessListener<Text>() {
                    ...
                    public void onSuccess(Text result) {
                        ...
                        for (Text.TextBlock block : result.getTextBlocks()) {
                            ...
                            blockObject.putMap("rect", getRectMap(Objects.requireNonNull(block.getBoundingBox())));

                            WritableArray lines = Arguments.createArray();
                            for (Text.Line line : block.getLines()) {
                                WritableMap lineObject = Arguments.createMap();
                                lineObject.putString("text", line.getText());
                                lineObject.putMap("rect", getRectMap(Objects.requireNonNull(line.getBoundingBox())));
